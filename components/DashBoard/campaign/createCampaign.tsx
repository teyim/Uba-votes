...
import { createCampaign } from 'helpers/adminHelpers';

type CreateCampaignProps = {
  showSuccessMessage: (message: string) => void;
};

function CreateCampaign({ showSuccessMessage }: CreateCampaignProps) {
  ...
  const { mutate, isLoading } = useMutation((campaignData: CampaignInput) =>
